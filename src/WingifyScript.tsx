...
const DEFAULT_WINGIFY_SMARTCODE_VERSION = 2.2;

const isValidWingifySmartCodeVersion = (
  version: number,
...
export const WingifyScript: React.FC<WingifyScriptProps> = ({
  accountId,
  version = DEFAULT_WINGIFY_SMARTCODE_VERSION,
  type = 'ASYNC',
  ...
  try {
    ...
    if (scriptType === 'sync') {
      const syncScriptUrl =
        version === 3.0
          ? `https://edge.wingify.net/tag/${accountId}.js`
          : `https://edge.wingify.net/lib/${accountId}.js`;
